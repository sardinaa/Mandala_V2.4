...
public class PatronControllerSpot2 : MonoBehaviour
{
    ...
    public static int countTurnOnSpot2 = 0;

    public GameObject mandalaTrace;
    private static Component[] llisteta;

    public static bool changeSpot2;

    // Start is called before the first frame update
    void Start()
    {
        llisteta = mandalaTrace.GetComponentsInChildren(typeof(PhyllotaxisSimple));
        timeact = GlobalVariables.TimeCircleActivatedSpot2;
        waitact = GlobalVariables.TimeCircleWaitingSpot2;
    ...
    void TurnOffCircle()
    {
        circleRight.material.SetColor("_EmissionColor", value: GlobalVariables.colcir * GlobalVariables._minIntensity);
        circleCenter.material.SetColor("_EmissionColor", value: GlobalVariables.colcir * GlobalVariables._minIntensity);
        circleLeft.material.SetColor("_EmissionColor", value: GlobalVariables.colcir * GlobalVariables._minIntensity);
        _thunderRigth.Stop();
        _thunderCenter.Stop();
        _thunderLeft.Stop();
        desactivated = true;
        ...
        if (countTurnOnSpot2 == GlobalVariables.npampallugues)
        {
