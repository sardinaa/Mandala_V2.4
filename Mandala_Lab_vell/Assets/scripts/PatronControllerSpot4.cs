...
public class PatronControllerSpot4 : MonoBehaviour
{
    ...
    public static int countTurnOnSpot4 = 0;

    public GameObject mandalaTrace;
    private static Component[] llisteta;

    public static bool changeSpot4;

    // Start is called before the first frame update
    void Start()
    {
        llisteta = mandalaTrace.GetComponentsInChildren(typeof(PhyllotaxisSimple));
        timeact = GlobalVariables.TimeCircleActivatedSpot4;
        waitact = GlobalVariables.TimeCircleWaitingSpot4;
    ...
    void TurnOffCircle()
    {
        ...
        if (countTurnOnSpot4 == GlobalVariables.npampallugues)
        {
